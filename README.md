...
| [02. Исследовательский анализ данных]() | Исследование объявлений о продаже квартир: выполнить предобработку данных, добавить новые столбцы, провести анализ данных, построить графики и сделать выводы.| *pandas* |
